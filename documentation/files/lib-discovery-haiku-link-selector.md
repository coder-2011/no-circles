...
## Purpose
Runs one Anthropic-compatible model call per topic to select the best candidate link from Sonar outputs.

## Behavior
1. Requires one provider API key:
