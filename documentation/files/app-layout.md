...
3. Sets browser/app icons to the shared brand asset (`/logo-no-circles-white-removed.png`).
4. Wraps all routes in root HTML/body shell.
5. Renders a fixed top-left home link with the app logo (`/logo-no-circles-white-removed.png`) using no surrounding border/background chrome.
