...
function buildSelectorPrompt(args: {
  ...
  return [
    ...
    "- reject pages where the primary content is dates, venue, speaker bios, or admin/program details rather than substantive analysis",
    "Reader-value requirement:",
    "- select for learning density, not keyword match density",
    ...
    "- if no candidate has substantive teachable content, return NULL",
    "Prefer signals:",
