...
function buildSelectorPrompt(args: {
  ...
  return [
    ...
    "Diversity guardrail:",
    "- avoid selecting a candidate that repeats the same angle as already selected items unless its evidence quality is clearly stronger",
    ...
    "- when evidence quality is comparable, prefer the candidate that broadens issue coverage into a different domain or lens",
